...
if __name__ == '__main__':
    ...
    # Data loading params
    tf.flags.DEFINE_float("test_sample_percentage", .01, "Percentage of the training data to use for validation")
    tf.flags.DEFINE_string("positive_data_folder", awlq_positives, "Data source for the positive data.")
    tf.flags.DEFINE_string("negative_data_folder", awlq_negs, "Data source for the negative data.")
    ...
    # word_model = gensim.models.KeyedVectors.load_word2vec_format(word2vec_model)
    print('')

    # Load data
    print('Loading data...')
    x_text, y = data_helper.load_data_and_labels(FLAGS.positive_data_folder, FLAGS.negative_data_folder)
    print('Data loaded, getting vocabulary...')
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            initW = data_helper.load_embedding_vectors_word2vec(vocabulary, word2vec_model, False)
